...
type SliverInterface interface {
	...
	UpdateStatus(ctx context.Context, sliver *v1.Sliver, opts metav1.UpdateOptions) (*v1.Sliver, error)
...
func (c *slivers) UpdateStatus(ctx context.Context, sliver *v1.Sliver, opts metav1.UpdateOptions) (result *v1.Sliver, err error) {
	result = &v1.Sliver{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("slivers").
